...
add_filter(
	'rest_post_query', function( $prepared_args, $request ) {
...
add_filter(
	'rest_prepare_post', function( $response, $the_post ) {
...
add_filter(
	'rest_collection_query', function( $prepared_args ) {
...
add_filter(
	'rest_prepare_collection', function( $response, $the_post ) {
		$response->data['img_url'] = get_post_meta( $the_post->ID, 'image_url', true );
